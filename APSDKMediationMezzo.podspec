Pod::Spec.new do |s|
    ...
    s.vendored_frameworks = "AdPopcornSSP_SDK/xcframework/APSDKMediationMezzo.xcframework", "AdPopcornSSP_SDK/xcframework/Lib/LibADPlus.xcframework", "AdPopcornSSP_SDK/xcframework/Lib/OMSDK_Cjnet.xcframework"
