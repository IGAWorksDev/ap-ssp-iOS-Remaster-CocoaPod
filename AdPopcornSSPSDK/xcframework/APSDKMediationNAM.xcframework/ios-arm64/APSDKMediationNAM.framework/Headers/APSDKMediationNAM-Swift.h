...
#ifndef APSDKMEDIATIONNAM_SWIFT_H
#define APSDKMEDIATIONNAM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="APSDKMediationNAM",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17APSDKMediationNAM26APSSPNAMNativeAdRenderable")
@interface APSSPNAMNativeAdRenderable : NSObject
@property (nonatomic, strong) GFPNativeSimpleAdView * _Nullable namNativewAdView;
